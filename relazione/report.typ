...
- The final Jetson summary is: train loss 1.3785, train accuracy 52.32%, test loss 1.3795, and test accuracy 52.41%. We weren't able to assest the Jetson model, the power mode, or the locked-clock configuration.
